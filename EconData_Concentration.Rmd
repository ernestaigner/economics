...
doc <- body_add_par(doc, paste0("Table 7: ", cap), style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_flextable(doc, value = xtable_to_flextable(xt), pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
# Word Export
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, paste0("Table 1: ", cap), style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_flextable(doc, value = xtable_to_flextable(xt), pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_par(doc, "Notes", style = NULL, pos = "after")
doc <- body_add_par(doc, "a The total sample of all articles and citations listed in the Web of Science subject category economics between 1956 and 2016. This sample is used for the analysis for article, journal, and author concentration.", style = NULL, pos = "after")
doc <- body_add_par(doc, "b The restricted sample covering all articles and citations of journals that were still being published in 2016. This sample is used for the analysis of paradigmatic concentration.", style = NULL, pos = "after")
doc <- body_add_par(doc, "c The sample covers the time period for which data on affiliation is available in the InCites database.", style = NULL, pos = "after")
doc <- body_add_par(doc, "This sample is used for the analysis of geographic and institutional concentration.", style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
...
ggplot(xt,aes(x=year)) + 
	...
	scale_colour_manual(name="",values=c("#d7191c", "#2b83ba")) + 
...
ggsave(file="export_tiff/fig1.tiff",width=20,height=20,units="cm",dpi = 600, device = "tiff")
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, "Figure 1: Number of articles and citations each year, 1956-2016", style = NULL, pos = "after")
doc <- body_add_gg(doc, g , style = "centered",width=4,height=4)
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
ggsave(file="export_tiff/fig2.tiff",width=20,height=20,units="cm",dpi = 600, device = "tiff")
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, "Figure 2: Number of published and cited journals eachyear, 1956-2016", style = NULL, pos = "after")
doc <- body_add_gg(doc, g , style = "centered",width=4,height=4)
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
ggsave(file="export_tiff/fig3.tiff",width=20,height=20,units="cm",dpi = 600, device = "tiff")
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, "Figure 3: Share of cumulative articles in the respective year cited at least once, 1956-2016", style = NULL, pos = "after")
doc <- body_add_gg(doc, g , style = "centered",width=4,height=4)
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
ggplot(xt,aes(year)) + 
	...
	scale_color_manual(name="",
						 ...
						 values=c("#d7191c", "#fdae61", "#2b83ba","#abdda4")) +
	ylab("Percent") + xlab("Year") + 
...
ggsave(file="export_tiff/fig4.tiff",width=20,height=20,units="cm",dpi = 600, device = "tiff")
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, "Figure 4: Share of citations to the top 1, 5, 10, 50 percent of articles each year, 1956-2016", style = NULL, pos = "after")
doc <- body_add_gg(doc, g , style = "centered",width=4,height=4)
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
ggsave(file="export_tiff/fig5.tiff",width=20,height=20,units="cm",dpi = 600, device = "tiff")
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, "Figure 5: Gini coefficients for the distribution of citations among the cited articles in the respective year, 1956-2016", style = NULL, pos = "after")
doc <- body_add_gg(doc, g , style = "centered",width=4,height=4)
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
# Word Export
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, paste0("Table 2: ", cap), style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_flextable(doc, value = xtable_to_flextable(xt), pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_par(doc, "Notes. Top 100, 500, and 1000 articles refers to the most-cited articles in the data set.", style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
...
ggplot(xt,aes(y = value*100,x=year,color=variable,linetype=variable)) + geom_line(size=0.8) + 
	scale_colour_manual(name="",values=c("#2b83ba","#2b83ba","#d7191c","#d7191c"),labels=labs) + 
...
ggsave(file="export_tiff/fig6.tiff",width=20,height=20,units="cm",dpi = 600, device = "tiff")
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, "Figure 6: Share of citations and articles of ‘Top Five’ journals, 1956-2014; corrected share normalised to 1970", style = NULL, pos = "after")
doc <- body_add_gg(doc, g , style = "centered",width=4,height=4)
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
g <- ggplot(xt,aes(x=year,color=variable,group=variable))  + 
	geom_point(aes(y = value,shape=variable), alpha = 0.9,size=1.1) + 
	geom_line(aes(y = average),size=0.8) + 
    scale_color_manual(name="",labels=labs,values=c("#d7191c", "#fdae61", "#2b83ba")) + 
...
ggsave(file="export_tiff/fig7.tiff",width=20,height=20,units="cm",dpi = 600, device = "tiff")
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, "Figure 7: Share of ‘Top Five‘ journals in 100, 500, 1000 most-cited articles each year, 5-year weighted moving average, 1956-2016", style = NULL, pos = "after")
doc <- body_add_gg(doc, g , style = "centered",width=4,height=4)
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
ggsave(file="export_tiff/fig8.tiff",width=20,height=20,units="cm",dpi = 600, device = "tiff")
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, "Figure 8: Gini coefficients of citations to cited journals in the respective year, 1956-2016", style = NULL, pos = "after")
doc <- body_add_gg(doc, g , style = "centered",width=4,height=4)
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
# Word Export
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, paste0("Table 3: ", cap), style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_flextable(doc, value = xtable_to_flextable(xt), pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_par(doc, "Notes.", style = NULL, pos = "after")
doc <- body_add_par(doc, "a The shares do not sum to 100 percent as co-authored articles are counted once for each region.", style = NULL, pos = "after")
doc <- body_add_par(doc, "b 13.07 percent of articles could not be assigned to a region.", style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
ggsave(file="export_tiff/fig9.tiff",width=20,height=20,units="cm",dpi = 600, device = "tiff")
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, "Figure 9: Share of articles by world region each year, 1980-2014", style = NULL, pos = "after")
doc <- body_add_gg(doc, g , style = "centered",width=4,height=4)
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
ggsave(file="export_tiff/fig10.tiff",width=20,height=20,units="cm",dpi = 600, device = "tiff")
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, "Figure 10: Share of citations to world region each year, 1980-2014", style = NULL, pos = "after")
doc <- body_add_gg(doc, g , style = "centered",width=4,height=4)
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
# Word Export
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, paste0("Table 4: ", cap), style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_flextable(doc, value = xtable_to_flextable(xt), pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_par(doc, "Notes. Citations per article specifies the mean number of citations an article receives. Top 100, 500, and 1000 articles refers to the most-cited articles in the data set.", style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
ggsave(file="export_tiff/fig11.tiff",width=20,height=20,units="cm",dpi = 600, device = "tiff")
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, "Figure 11: Share of articles and citations of top 20 institutions, 1980-2014; corrected share normalised to 1995", style = NULL, pos = "after")
doc <- body_add_gg(doc, g , style = "centered",width=4,height=4)
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
ggsave(file="export_tiff/fig12.tiff",width=20,height=20,units="cm",dpi = 600, device = "tiff")
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, "Figure 12: Share of top 20 institutions in the 100, 500, 1000 most-cited articles each year, 5-year weighted moving average, 1980-2014", style = NULL, pos = "after")
doc <- body_add_gg(doc, g , style = "centered",width=4,height=4)
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
# Word Export
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, paste0("Table 5: ", cap), style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_flextable(doc, value = xtable_to_flextable(xt), pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_par(doc, "Notes. A full list of the 100 top authors can be found in table 8 in the appendix.", style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
# Word Export
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, paste0("Table 6: ", cap), style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_flextable(doc, value = xtable_to_flextable(xt), pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_par(doc, "Notes.", style = NULL, pos = "after")
doc <- body_add_par(doc, "a Refers to all journals that are in the Web of Science subject category economics but are not listed in the Heterodox Economics Directory.", style = NULL, pos = "after")
doc <- body_add_par(doc, "b Refers to all journals that are in the Web of Science subject category economics and are listed in the Heterodox Economics Directory.", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
ggsave(file="export_tiff/fig13.tiff",width=20,height=20,units="cm",dpi = 600, device = "tiff")
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, "Figure 13: Share of heterodox articles and citations, 1956-2016; corrected share normalised to 1970", style = NULL, pos = "after")
doc <- body_add_gg(doc, g , style = "centered",width=4,height=4)
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
ggplot(xt,aes(x=year,color=variable,group=variable))  + 
	geom_point(aes(y = value,shape=variable), alpha = 0.9,size=1.1) + 
	geom_line(aes(y = average),size=0.8) + 
    scale_color_manual(name="",labels=labs,values=c("#d7191c", "#fdae61", "#2b83ba","#abdda4")) + 
	scale_shape_discrete(name="",labels=labs) +
    scale_x_continuous(breaks=c(seq(1956, 2016, 10),2016)) + 
	scale_y_continuous(breaks=c(seq(0,100,10))) +
...
ggsave(file="export_tiff/fig14.tiff",width=20,height=20,units="cm",dpi = 600, device = "tiff")
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, "Figure 14: Share of top 1, 5, 10, 50 percent of articles that were published in heterodox journals, 1956-2016", style = NULL, pos = "after")
doc <- body_add_gg(doc, g , style = "centered",width=4,height=4)
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
# Word Export
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, paste0("Table 8: ", cap), style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
names(xt)[6:10] <- paste0(names(xt)[6:10],"-")
doc <- body_add_flextable(doc, value = xtable_to_flextable(xt), pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
# Word Export
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, paste0("Table 9: ", cap), style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
names(xt)[7:12] <- paste0(names(xt)[7:12],"-")
doc <- body_add_flextable(doc, value = xtable_to_flextable(xt), pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_par(doc, "Notes. WR: World Region, NA: North America, WE: Western Europe, O: Oceania, ME: Middle East, AS: Asia, EE: Eastern Europe, LA:Latin America, AF: Africa.", style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
print(doc, target = "export_word/tables.docx")
...
# Word Export
doc <- body_add_break(doc, pos = "after")
doc <- body_add_par(doc, paste0("Table 10: ", cap), style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_flextable(doc, value = xtable_to_flextable(xt), pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
doc <- body_add_par(doc, "", style = NULL, pos = "after")
